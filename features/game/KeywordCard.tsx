...
// Helper function to safely render metric values that might be objects.
      ...
      <div className="relative">
        ...
        <div className="p-4 cursor-pointer hover:bg-stone-700/50" onClick={onSelect}>
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-xs font-medium bg-sky-900 text-sky-300 px-2 py-1 rounded-full">{card.metrics.keywordIntent}</span>
          </div>
